...
-- =============================================================================
-- Seed: a default technician and baseline settings so the app is usable on
-- first launch. (Hard rule: no fake business data, only the minimum bootstrap.)
-- =============================================================================
INSERT INTO technicians (name, role, color) VALUES ('Shop Owner', 'owner', '#3B82F6');
INSERT INTO app_settings (key, value) VALUES
  ('shop.name', '"My Repair Shop"'),
  ('shop.address', '""'),
  ('shop.phone', '""'),
  ('shop.email', '""'),
  ('shop.logo_path', '""'),
